    ...
    try:
        ...
        if parse_with_groq and final_text.strip():
            ...
            if groq_result['success']:
                ...
                response_data['formatted_cv'] = cv_parser.format_cv_json(groq_result)
...
<body>
    <div class="container">
        ...
        <p>Upload a PDF file to extract text using CRAFT + CRNN OCR</p>
    ...
    <script>
        ...
        function displayResults(data) {
            ...
            data.pages.forEach(page => {
                ...
                html += '<p>' + page.results.full_text + '</p>';
                html += '</div>';
            });
...
# Updated Flask app with better coordination
from flask import Flask, request, jsonify, render_template_string
import easyocr
import cv2
import numpy as np
